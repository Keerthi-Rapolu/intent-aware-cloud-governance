...
simulation calibration, prevents \$97.92 in a runaway ML runtime scenario,
improves IFS-based anomaly-detection F1 to 0.7608 versus 0.6054 for a
CPU-threshold baseline, and reaches peak CPS of 0.733, a 58$\times$
improvement over the No Phase 3 baseline. These results suggest that cloud
governance benefits from moving intervention earlier in the execution lifecycle
