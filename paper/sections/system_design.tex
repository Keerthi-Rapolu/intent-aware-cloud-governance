...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth, trim=0 80pt 0 80pt, clip]{figures/architecture_overview.pdf}
...
Historical similarity retrieval uses FAISS \cite{faiss2024} to query prior workload-intent
