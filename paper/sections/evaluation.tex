...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/exp0_calibration.pdf}
\caption{Simulation calibration for Exp~0. Predicted utilization closely tracks observed utilization, with utilization MAE of 0.054 and cost rel-RMSE of 0.306.}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\columnwidth]{figures/exp1_preprovision.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\columnwidth]{figures/exp2_runtime_timeline.pdf}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=\columnwidth]{figures/exp3_detector_comparison.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/exp6_convergence.pdf}
\caption{Policy-learning convergence in Exp~6. Full PBCP reaches peak CPS of 0.733 versus 0.013 for the No Phase 3 baseline, a 56$\times$ improvement.}
