...
\begin{figure*}[t]
\centering
\includegraphics[width=0.96\textwidth]{figures/exp0_calibration.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.88\linewidth]{figures/exp1_preprovision.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.82\linewidth]{figures/exp2_runtime_timeline.pdf}
...
\resizebox{0.72\textwidth}{!}{\input{tables/exp2_runtime_cases}}
\end{table*}
