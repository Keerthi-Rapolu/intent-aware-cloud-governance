...
Within the intent-behavior divergence framing, IFS measures semantic alignment
between workload intent and runtime behavior. The relationship among the metrics
is deliberate: CPS indicates how much waste was prevented, ESR indicates whether
prevention remained operationally safe, and IFS helps explain why a workload
diverged from its expected behavior in the first place.
